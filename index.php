<!DOCTYPE html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="\messagerie\css\style.css">
    ...
    <body>
        ...
        <section class="container forms">
            <div class="form login">
                <div class="form-content">
                    <header>Login</header>
                    <form action="\messagerie\includes\login.php" method="post">
            ...
            <div class="form signup">
                <div class="form-content">
                    ...
                    <form action="\messagerie\includes\signup.php" method="post">
                        <div class="field input-field">
        ...
        <!-- JavaScript -->
        <script src="\messagerie\js\script.js"></script>
    </body>
</html>